...
[
  {
    ...
    "desc": "Arbiter is an official desktop minesweeper clone that can be used for the Authoritative Minesweeper rankings. It saves replays for games played and tracks many different stats. This clone cannot be resized, so will appear small on high res screens (unless you lower screen resolution). All clones allowed for the Authoritative Minesweeper rankings have left+right chord (this is different from minesweeper.online which defaults to left-click chord). It is no longer under active development.",
